...
<div class="row">
    ...
    <div class="col-4 mb-3">
        ...
        <input type="tel" name="telefone" class="form-control form-control-lg bg-light" value="" required>
    </div>
</div>
<div class="row">
    <div class="col-4 mb-3">
    ...
    <div class="col-4 mb-3">
        ...
        <input type="text" name="salario" class="form-control form-control-lg bg-light" value="" required>
    </div>
</div>
<div class="row">
